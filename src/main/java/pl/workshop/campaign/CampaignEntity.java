...
public class CampaignEntity extends AbstractEntityType<CampaignEntity> {
    ...
    public final static EntityField<CampaignEntity, CampaignType> TYPE = INSTANCE.field(CampaignTable.type, EnumAsStringValueConverter.create(CampaignType.class)); // TODO: define field type as enum by using EnumAsStringValueConverter
